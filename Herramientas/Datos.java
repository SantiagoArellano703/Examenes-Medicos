...
public class Datos {
    ...
    private String pacientes[] = {"Chacon Luis 20456789 M 32 04166769999 2",
    "Perez Maria 21345678 F 25 04125463561 4",
    "Mora Doris 22123456 F 36 04146764567 3",
    "Alvarez Jose 19876543 M 04267564636 2",
    "Suarez Rosana 27768456 F 04243456789 1"};
    ...
    public int longExamenes(){
        int cont=0;
        for(String vector: examenes){
            cont++;
        }
        return cont;
    }
    
    public String getPacientes(int i){
        String cadena;
        try{
            cadena = pacientes[i];
            return cadena;
